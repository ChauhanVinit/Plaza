  ...
  return (
    <>
      ...
      <div className="relative mb-20">
        <Image src={RequestAQuoteImage} alt="RequestAQuoteImage" />
        <div className="w-full min-h-[504px] absolute bottom-0 bg-[#0C2459]/80 flex items-center justify-center text-center">
          <div>
            <h1 className="mb-8 font-urbanist text-[56px]  leading-[64px] font-bold text-white">
              Request A Quote
            </h1>
            <p className="max-w-[888px] font-jakarta text-lg !leading-[30px] font-normal text-white">
              Select the security service you are interested in, fill out the
              form below to request a quote customized to your needs, & we will
            ...
            <div className="mt-14 inline-flex items-center gap-4">
              ...
              <Button
                variant="custom"
                style={
                  "!min-w-[162px] !bg-transparent !text-white border-white"
                }
                name="Contact Us"
                path="/Contact-Us"
              />
