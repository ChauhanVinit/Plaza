...
const FreeQuote = () => {
  ...
  return (
    <div className="lg:mb-[400px] xl:mb-[360px]">
      <div className="max-h-auto lg:max-h-[440px] xl:max-h-[500px] relative xxs:container xl:max-w-[1200px] mx-4 xxs:mx-auto mb-10 mt-10 lg:mt-0 lg:mb-[160px] xl:mb-[140px] px-4 sm:px-6  xl:px-10 2xl:px-[60px] bg-[#0C2459] rounded-[40px]">
        <Image
          src={lineShape}
        ...
        <div className="relative grid grid-cols-12 lg:grid-cols-11 lg:gap-10 text-center lg:text-left">
          <div className="col-span-12 lg:col-span-4 pt-8 sm:pt-10  xl:pt-[60px]">
            <Tag
          ...
          <div className="col-span-12 lg:col-span-6 pb-8 sm:pb-10 pt-8  lg:pb-0 lg:pt-10 xl:pt-[60px]">
            <div
