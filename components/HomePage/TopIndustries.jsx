...
const TopIndustries = () => {
  ...
  return (
    <div className="max-w-[1440px] mx-auto py-20 px-[70px] grid grid-cols-12 items-center ">
      <div className="col-span-4">
        <h3 className="font-dmSans text-[32px] font-bold !leading-10 text-[#171A1D] tracking-[-1px]">
