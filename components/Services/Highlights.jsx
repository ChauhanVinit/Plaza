...
const Highlights = ({ data, title, desc, image }) => {
  return (
    <div id="highlights" className=" mx-4 sm:mx-6 xl:mx-10  2xl:container 2xl:mx-auto mb-10
     2xl:mb-[68px] px-4 py-10 sm:px-6 xl:px-8 2xl:px-16 2xl:p-16 rounded-[40px] bg-[#EDF5FF]/50">
      ...
      <div className="mt-[60px] flex flex-col xl:flex-row gap-8 xl:gap-10 2xl:gap-[74px] ">
        ...
        <div className="grow flex items-center justify-center  xs:px-4">
          <Image src={image} alt="BenefitsIMG" className="min-w-full xs:min-w-[440px]" />
        </div>
