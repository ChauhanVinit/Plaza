...
const Hero = ({title,desc,img}) => {
  ...
  return (
    <div className="w-full pl-[calc((100%-1360px)/2)] mt-24 mb-20">
    ...
    <div className="grid grid-cols-12">
      <div className="col-span-6">
        ...
        <div className="inline-flex items-center mt-[136px] mb-[60px]">
          {scrollIntoData.map((item) => (
            <button
              key={item.id}
              className="px-[14px] py-[22px] font-jakarta font-semibold text-base text-[#B0BABF]"
      ...
      <div className="col-span-6 relative -top-10">
        ...
        <div className="absolute top-0 z-[1] left-0 w-1/2 h-full bg-[linear-gradient(to_right,rgba(255,255,255,1)_11%,rgba(255,255,255,0)_76%)]"></div>
      </div>
    </div>
  </div>
  )
