      ...
      <div className="col-span-6">
        ...
        <div className="mt-[60px] flex flex-col gap-4">
          {data.map((item, index) => (
            <div
              key={index}
              className={`p-6 rounded-2xl border border-[#E0EAFF] cursor-pointer transition-all ease-in-out duration-500`}
            ...
            >
              ...
              >
                <p className="mt-2 font-jakarta text-base font-normal text-[#374049]">
                  {item.description}
                </p>
              </div>
            </div>
