...
const Button = ({
  ...
  const buttonContent = (
    <div
      className={`w-full transition-all duration-300 ease-in-out group flex items-center justify-between  sm:justify-center  gap-2 cursor-pointer text-sm  xxs:text-base font-semibold font-dmSans capitalize px-4 xxs:px-6 sm:py-2 sm:px-2 h-14 xs:h-16 overflow-hidden ${bgtransparent} ${
        variant === "custom"
